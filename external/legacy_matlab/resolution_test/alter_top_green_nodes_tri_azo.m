function G=alter_top_green_nodes_tri_azo(G_raw,slip_model,slip_model_unaltered,data_insar,varargin)
...
for k=1:N_patch_altered
    if slip_model(k,3)==1
        ...
        [ue1,un1,~]=TDdispHS(xe_insar,yn_insar,zinsar,vert1,vert2,vert3,1,0,0,nu);%strike-slip
        [ue2,un2,~]=TDdispHS(xe_insar,yn_insar,zinsar,vert1,vert2,vert3,0,1,0,nu);%dip-slip
